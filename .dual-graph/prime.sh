#!/usr/bin/env bash
PORT=$(cat "/home/jacques/Documents/DEV/PERSO/tictacdoh/.dual-graph/run/claude/mcp_port" 2>/dev/null || echo 8081)
...
if [[ -f "/home/jacques/Documents/DEV/PERSO/tictacdoh/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/home/jacques/Documents/DEV/PERSO/tictacdoh/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject AUDIT_CONTEXT.md if recent (< 7 days) — tells Claude what to fix
AUDIT_CTX="/home/jacques/Documents/DEV/PERSO/tictacdoh/.dual-graph/AUDIT_CONTEXT.md"
if [[ -f "$AUDIT_CTX" ]]; then
...
STORE="/home/jacques/Documents/DEV/PERSO/tictacdoh/.dual-graph/context-store.json"
